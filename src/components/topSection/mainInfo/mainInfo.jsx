...
export const MainInfo = ({ weatherData, city, forecast, selectValue, onChange, state }) => {
      ...
      <div className="container">
        <div className="additionalInfo">
          <div>
            ...
            <div className="date">
              <div>{dayList[date.getDay()] + " " + date.toLocaleDateString()}</div>
              <TimePicker forecast={forecast} value1={selectValue} onChange={onChange} state={state} />
            </div>
          </div>
          <div className="icon">
